...
;;;;
**%%ID%%,oompPart.oompID,sourceList.manufacturer.company&&0&&**Distributor Search | <b>(D)</b>Digikey,&nbsp;<b>(M)</b>Mouser,<br /><b>(F)</b>Farnell(UK),&nbsp;<b>(R)</b>RS(UK) | Search Engines | <b>(O)</b>Octopart,&nbsp;<b>(P)</b>Parts.io,&nbsp;<br /><b>(U)</b>Upverter,<b>(A)</b>AliExpress,&nbsp;<br /><b>(T)</b>Taobao,&nbsp;<b>(G)</b>Google | 
